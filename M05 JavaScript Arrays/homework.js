...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var incrementoArray = array.map(num => {return num + 1})
...
function diaDeLaSemana(numeroDeDia) {
   ...
   for(var i = 0; i < 7;i++){
      if(diasDeLaSemana[numeroDeDia - 1] === 1 || diasDeLaSemana[numeroDeDia - 1] === 7){
...
function todosIguales(array) {
   ...
   // Tu código:
   var siguienteNumero = array[1];
   var bandera = 0;
   for(var i = 0; i < array.length;i++){
      if(siguienteNumero === array[i]){
         siguienteNumero = array[i];
         bandera = 1;
      }else{
         bandera = 0;
      }
